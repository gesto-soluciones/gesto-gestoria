        ...
        <>
            <section className="text-slate-800/80 w-full mt-32 pt-16 pb-4 bg-slate-100 text-white">
                <div className="flex w-full gap-4 justify-center">
                    ...
                    <a href="https://www.instagram.com/gestosoluciones/" target="_blank" rel="noreferrer" className="rounded-full p-3 hover:bg-main hover:text-white bg-white text-main cursor-pointer transition-colors shadow-md">
